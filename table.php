...
<!-- <script>
  ...
  function delete_agent($id){
      ...
      <input type="text" name="idr"> <input type="text" name="sts"> <input type="submit" name="submit">
      </form> 
</body>
</html>
<?php 
if(isset($_POST['submit'])){
							$zc = $_POST['sts'];
							$idr = $_POST['idr'];
							//$q2 = "INSERT INTO `docs` (`status`) VALUES ('$zc') WHERE `id`='$idr'";
							$q2 = "UPDATE `docs` SET `status` = '$zc' WHERE `id`='$idr'";
